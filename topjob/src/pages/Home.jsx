...
export default function HomePage() {
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-b from-slate-50 to-slate-200">
      {/* Hero Section with interactive slides */}
      <section
        className="relative flex flex-col items-center justify-center text-center px-4 py-20 md:py-32 shadow-lg min-h-[350px] md:min-h-[420px] bg-slate-900"
      ...
      {/* About Section */}
      <section id="about" className="py-16 px-4 md:px-0 bg-white border-b border-slate-200 scroll-mt-24">
      ...
      {/* Services Section */}
      <section id="services" className="py-20 px-2 md:px-8 bg-emerald-50 border-b border-slate-200 scroll-mt-24">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-16 px-4 md:px-0 bg-indigo-50 scroll-mt-24">
